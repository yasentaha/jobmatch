...
class CompanyService_Should(unittest.TestCase):
    ...
    def test_getAllCompanies_returnsCorrect_WhenCompaniesPresent(self):
        get_data_func = lambda q: [(1,'Test','Test_company',
                                       'testtest','test@gmail.com',
                                       '0878787878','Test','Sofia',1)]
        result = company_service.get_all_companies(get_data_func)
        expected = [Company(id= 1,
                            user_name= 'Test',
                            company_name= 'Test_company',
                            description= 'testtest',
